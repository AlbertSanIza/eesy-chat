        ...
        <div className="fixed bottom-0 left-0 flex w-full">
            ...
            <div className="flex-1 px-4 sm:px-8">
                <form
                    ...
                    className="z-50 mx-auto max-w-2xl rounded-t-3xl border-x border-t bg-sidebar/80 px-1.5 pt-1.5 shadow-2xl shadow-sky-300 backdrop-blur-xs dark:shadow-none"
                >
